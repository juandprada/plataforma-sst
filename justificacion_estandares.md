# Justificación Legal de la Tabla de Contenido del SG-SST 🇨🇴

Este documento técnico explica la lógica detrás de la clasificación por estrellas (★, ★★, ★★★) utilizada en la **Tabla de Contenido** de la Plataforma SST, basándose en la normatividad colombiana vigente.

---

## 1. El Marco Legal: Decreto 1072 vs. Resolución 0312

Es común confundir las exigencias del **Decreto 1072 de 2015** con las de la **Resolución 0312 de 2019**. Para entender nuestra tabla de contenido, debemos ver cómo interactúan:

*   **El Decreto 1072 de 2015 (Capítulo 6):** Es la **ley marco**. Obliga a **todas** las empresas en Colombia a tener un Sistema de Gestión de Seguridad y Salud en el Trabajo (SG-SST) funcional, basado en el ciclo PHVA (Planear, Hacer, Verificar, Actuar). No importa si tienes 1 o 1000 empleados, el 1072 te exige proteger a tus trabajadores.
*   **La Resolución 0312 de 2019:** Es la **herramienta de evaluación**. Define los "Estándares Mínimos", que funcionan como una lista de chequeo (*checklist*) que el Ministerio de Trabajo usa para auditarte. La 0312 reconoce que una panadería de 3 empleados no puede tener la misma carga documental que una petrolera de 500, por lo que **segmenta las exigencias** en 7, 21 y 60 estándares.

> [!IMPORTANT] 
> **La regla de oro:** Cumplir los Estándares Mínimos (Res 0312) no te exime de la obligación de proteger a tus trabajadores (Dec 1072). Los estándares son solo un piso legal, no el techo.

---

## 2. Explicación de los Niveles (Clasificación por Estrellas)

En nuestra plataforma, hemos categorizado los documentos para evitar el exceso de papel en empresas pequeñas, respetando estrictamente la Ley.

### ★ Nivel Básico (7 Estándares)
**¿A quién aplica?** Empresas, empleadores y contratantes con **10 o menos trabajadores** clasificadas con riesgo I, II o III.

**Justificación Documental:** 
Según el Artículo 3 de la Resolución 0312, a estas microempresas se les exige únicamente la "columna vertebral" operativa del SG-SST para garantizar la salud básica de sus operarios sin ahogarlos en burocracia.
*   **Acta de asignación:** Alguien debe responder por el sistema.
...
## 3. Recursos y Artículos Recomendados (Posts para ampliar)

Si algún cliente, contratista o auditor cuestiona el porqué de la organización documental, puedes referenciarlos a la siguiente información pública y portales especializados en Colombia:

1.  **Safetya.co** (Portal líder en SST en Colombia):
    *   *Artículo recomendado:* "Diferencia entre el Decreto 1072 y la Resolución 0312". Explica gráficamente por qué una cosa es el "qué" y otra el "cómo".
2.  **Fondo de Riesgos Laborales (MinTrabajo):**
    *   *Sitio Oficial:* [fondoriesgoslaborales.gov.co](https://www.fondoriesgoslaborales.gov.co). Sección de normatividad.
3.  **El peligro de "cumplir solo el mínimo":**
    *   Muchos prevencionistas advierten que una empresa de 7 estándares que enfrente un accidente grave, puede ser juzgada bajo el marco del Decreto 1072 por un juez laboral si se demuestra negligencia (ej. no tener política o comités, aunque la 0312 no lo exigiera directamente para evaluación de estándares). Por eso, *implementar los documentos de niveles superiores siempre es una buena práctica recomendada.*
